...
<% 
	...
	<div class="row">
      <div class="col-md-9">
        ...
        <form method = "POST" action ="/CRONO/ViewEmployees" class="form-horizontal" role="form">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-md-8">
              <input class="form-control" name = "Role" type="Integer" placeholder="0 = admin or 1 = employee">
            </div>
          </div>
          <div class="form-group">
